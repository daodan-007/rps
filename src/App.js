...
class App extends Component {
      ...
      .then( (response) => {
        setInterval( () => {
          this.state.web3.eth.getBalance(this.state.account, (error, result) => {
            ...
            if (currentBalance !== this.state.accountBalance) {
              this.updateBalances();
            }
          })
        }, 100);
  ...
  //
  getOwner(){
      this.state.contract.owner.call()
      .then((response) => {
  ...
  handleGetBalance(event) {
      event.preventDefault();
      this.state.contract.Successd({from: this.state.account})
      .then( (response) => {
          // Function must have a callback
      });
  }
  ...
  render() {
    return (
      <div className="App" style={{background:"block"}}>
        <nav className="navbar pure-menu pure-menu-horizontal">
            <a href="#" className="pure-menu-heading pure-menu-link">Bifurcation Terminal </a>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="#" className="home">home</a>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="#" className="contract">contract</a>
        </nav>
